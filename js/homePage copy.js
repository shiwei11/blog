...
function backRenderAnimation1() {
  const tentacleSetting_mobile = {
    tentacleCount: 20,//触手数量
    segmentCountMin: 8,//触手节点数量最小值
    segmentCountMax: 15,//触手节点数量最大值
    segmentLengthMin: 20,//触手长度最小值
    segmentLengthMax: 30,//触手长度最大值
    colonyRadius: 100,//菌群生成半径
  }
  const tentacleSetting_PC = {
    tentacleCount: 30,//触手数量
    segmentCountMin: 10,//触手节点数量最小值
    segmentCountMax: 20,//触手节点数量最大值
    segmentLengthMin: 20,//触手长度最小值
    segmentLengthMax: 40,//触手长度最大值
    colonyRadius: 200,//菌群生成半径
  }
  ...
  class Tentacle {
    ...
    updateBase() {
      let t = simplex.noise3D(this.base[0] * 0.005, this.base[1] * 0.005, tick * 0.005) * 2 * PI;
      this.base.lerp([
