...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("verilog",(()=>{"use strict";return e=>({name:"Verilog",
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:c}}})());hljs.registerLanguage("matlab",(()=>{"use strict";return e=>{var a={relevance:0,
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*%\\{\\s*$","^\\s*%\\}\\s*$"),e.COMMENT("%","$")]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("vbnet",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
contains:[c]}]}}})());hljs.registerLanguage("vhdl",(()=>{"use strict";return e=>({name:"VHDL",
...
begin:"'[A-Za-z](_?[A-Za-z0-9])*",contains:[e.BACKSLASH_ESCAPE]}]})})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
...
end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})})());hljs.registerLanguage("java",(()=>{"use strict"
