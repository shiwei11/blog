...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `apache` grammar compiled for Highlight.js 11.8.0 */
...
})();hljs.registerLanguage("apache",e)})();/*! `bash` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("css",e)})();/*! `go` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("go",e)})();/*! `java` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict"
...
illegal:"\\S"}}})();hljs.registerLanguage("json",e)})();/*! `lua` grammar compiled for Highlight.js 11.8.0 */
...
illegal:"[^\\s\\}\\{]"}}})();hljs.registerLanguage("nginx",e)})();/*! `python` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("python",e)})();/*! `shell` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("typescript",e)})();/*! `xml` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>{
