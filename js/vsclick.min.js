!(function (t, n) {
  ...
  return (function (t) {
    ...
    function (t, n, r) {
      ...
      function f(t, n) {
        for (var r = {}, e = [], o = 0; o < t.length; o++) {
          ...
          -1 !== p
            ? (u[p].references++, u[p].updater(l))
            : u.push({ identifier: s, updater: x(l, n), references: 1 }),
            e.push(s);
        }
        return e;
      }
    ...
    function (t, n, r) {
      (t.exports = r(81)(!1)).push([
        t.i,
        ".vsClick{position:fixed;z-index:999999;top:0;left:0;pointer-events:none}.vsClick-dom{position:absolute;z-index:999999;top:0;left:0;pointer-events:none}\n",
        "",
      ]);
    },
    function (t, n, r) {
    ...
    function (t, n, r) {
      ...
      t.exports = function (t, n, r) {
        return (
          (n = (r ? u(t, n, r) : void 0 === n) ? 1 : c(n)), (i(t) ? e : o)(t, n)
        );
      };
    },
    function (t, n, r) {
    ...
    function (t, n, r) {
      ...
      t.exports = function (t, n, r) {
        if (
          (r && "boolean" != typeof r && o(t, n, r) && (n = r = void 0),
          void 0 === r &&
            ("boolean" == typeof n
              ? ((r = n), (n = void 0))
    ...
    function (t, n, r) {
      ...
      var e = [
        ...
        o = function () {
          ...
          return (
            t.config || (t.config = {}),
            t.config.emoji &&
              ((t.config.emoji instanceof Array &&
                t.config.emoji.every(function (t) {
                  return "string" == typeof t;
                })) ||
                delete t.config.emoji),
            t.config.dom &&
              ((t.config.dom = document.getElementsByClassName(
                t.config.dom
              )[0]),
              t.config.dom instanceof Element || delete t.config.dom),
          ...
          function () {
            ...
            (this.initDom = function () {
              (t.cvs = document.createElement("canvas")),
                ...
                t.dom != window
                  ? t.dom.appendChild(t.cvs)
                  : document.body.appendChild(t.cvs);
            }),
              this.initDom();
          },
        ],
      ...
      function l(t) {
        ...
        (n.option = {
          ...
          t.color instanceof Array &&
            (n.option.color = t.color[p.a.random(0, t.color.length - 1)]),
          t.vx instanceof Array &&
            (n.option.vx = parseFloat(
              p.a.random(t.vx[0], t.vx[1], !0).toPrecision(3)
            )),
          t.vy instanceof Array &&
            (n.option.vy = parseFloat(
              p.a.random(t.vy[0], t.vy[1], !0).toPrecision(3)
            )),
          t.emoji instanceof Array &&
            (n.option.emoji = t.emoji[p.a.random(0, t.emoji.length - 1)]);
        var r = n.option;
        r.emoji
          ? ((r.x = r.x - r.width / 1.5), (r.y = r.y + r.height / 3))
          : ((r.x = r.x - r.width / 2), (r.y = r.y - r.height / 2)),
          ...
          (n.attrSlide = function () {
            var t = r.emoji ? r.height / 5 : r.height;
            r.y >= r.cvs.height - t &&
              ((r.vydown = 0), (r.y = r.cvs.height - t), (r.vx = r.vx * r.f));
          }),
      ...
      function v() {
        ...
        (this.sudoku = function (t) {
          setTimeout(c, 0, { x: t.x, y: t.y }),
            setTimeout(c, 50, { x: t.x, y: t.y - i }),
            setTimeout(c, 100, { x: t.x + o, y: t.y }),
            setTimeout(c, 150, { x: t.x + o, y: t.y - i }),
            setTimeout(c, 200, { x: t.x - o, y: t.y }),
            setTimeout(c, 250, { x: t.x, y: t.y + i }),
            setTimeout(c, 300, { x: t.x + o, y: t.y + i }),
            setTimeout(c, 350, { x: t.x - o, y: t.y - i }),
            setTimeout(c, 400, { x: t.x - o, y: t.y + i });
        }),
          (this.timer = function (t) {
            for (var n = 0; n < 10; n++)
              setTimeout(c, 50 * n, { x: t.x, y: t.y });
          }),
      ...
      var d = [
        function () {
          ...
          this.observer = {
            ...
            run: function () {
              t.length > 0 &&
                a.a.forEachRight(t, function (t, n) {
